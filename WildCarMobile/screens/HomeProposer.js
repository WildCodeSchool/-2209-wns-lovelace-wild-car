    ...
    <View style={styles.container}>
      <View style={styles.topSection}>
        <View style={styles.buttonContainer}>
          <TouchableOpacity style={styles.buttonPropose}>
            <Text style={{ color: 'white', fontWeight: '900' }}>
              je propose
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={styles.buttonRecherche}
            onPress={() => navigation.navigate('homeRecherche')}
          >
      ...
      <View style={styles.cardContainer}>{/* <RideCardMobile />*/}</View>
    </View>
  );
}
